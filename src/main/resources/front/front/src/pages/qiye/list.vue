    ...
    >
      ...
      >
        ...
        >
          ...
          <el-input
            v-model="formSearch.qiyezhanghao"
            placeholder="企业账号"
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      if (this.formSearch.qiyezhanghao != "")
        searchWhere.qiyezhanghao = "%" + this.formSearch.qiyezhanghao + "%";
      if (!this.centerType) {
        params["sfsh"] = "是";
      }
      ...
      this.$http
        .get(`qiye/${this.centerType ? "page" : "list"}`, {
