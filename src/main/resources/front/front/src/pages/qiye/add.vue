...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ...
        xingbie: [],
        shoujihaoma: [{ validator: this.$validate.isMobile, trigger: "blur" }],
        touxiang: [],
        qiyemingcheng: [],
        sfsh: [],
        shhf: [],
  ...
  methods: {
    ...
    info() {
      this.$http
        .get(`qiye/detail/${this.$route.query.id}`, { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
