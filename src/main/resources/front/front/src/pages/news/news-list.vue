  ...
  <div>
    ...
    >
      <el-form
        ...
        class="list-form-pv"
        :style="{
          border: '4px solid rgba(254, 105, 23, 1)',
          padding: '0',
      ...
      >
        ...
        <div
          ...
          @click="categoryClick(index + 1)"
          :key="index"
          class="item"
          :class="categoryIndex == index + 1 ? 'active' : ''"
        >
          {{ item.typename }}
        </div>
      </div>
      ...
      <div class="list3 index-pv1" :style="{ width: '100%', height: 'auto' }">
        ...
        >
          ...
          >
            ...
            ></span>
            <span
              :style="{ color: 'inherit', lineHeight: '1.5', fontSize: '14px' }"
              >{{ item.addtime }}</span
            >
          </div>
          <div
  ...
  methods: {
    ...
    getNewsList(page) {
      ...
      if (this.categoryIndex != 0) {
        searchWhere.typename =
          this.categoryList[this.categoryIndex - 1].typename;
      }
      this.$http
