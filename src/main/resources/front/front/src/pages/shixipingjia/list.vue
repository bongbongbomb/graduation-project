    ...
    >
      ...
      >
        ...
        >
          ...
          <el-input
            v-model="formSearch.xueshengxingming"
            placeholder="学生姓名"
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/shixipingjiaAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.shixitupian.split(',')[0])"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
                ...
                v-if="
                  item.shixitupian && item.shixitupian.substr(0, 4) == 'http'
                "
                :src="item.shixitupian.split(',')[0]"
                class="image"
              />
              <img
                @click.stop="
                  imgPreView(
                    baseUrl +
                      (item.shixitupian ? item.shixitupian.split(',')[0] : ''),
                  )
                "
                :style="{
                  width: '100%',
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.xueshengxingming != "")
        searchWhere.xueshengxingming =
          "%" + this.formSearch.xueshengxingming + "%";
      ...
      this.$http
        .get(`shixipingjia/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/shixipingjiaDetail", query: params });
    },
