<template>
  ...
  >
    ...
    >
      ...
      >
        <el-input-number
          v-model="ruleForm.shixipingfen"
          placeholder="实习评分"
          :disabled="false || ro.shixipingfen"
        ></el-input-number>
      </el-form-item>
      <el-form-item
        :style="{
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ...
        shixitupian: [],
        shixipingfen: [{ validator: this.$validate.isNumber, trigger: "blur" }],
        pingjianeirong: [],
        pingjiashijian: [],
        qiyezhanghao: [],
        fuzeren: [],
  ...
  methods: {
    ...
    info() {
      this.$http
        .get(`shixipingjia/detail/${this.$route.query.id}`, {
          emulateJSON: true,
        })
        .then((res) => {
          if (res.data.code == 0) {
