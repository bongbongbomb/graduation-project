    ...
    >
      ...
      >
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/shixishenqingAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      this.$http
        .get(`shixishenqing/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/shixishenqingDetail", query: params });
    },
