    ...
    >
      ...
      >
        ...
        <el-breadcrumb-item
          ...
          :key="index"
          :to="'/index/aboutus?centerType=' + (centerType ? '1' : '0')"
        ...
        >
          ...
          >
            ...
            <el-button
              ...
              v-if="btnAuth('aboutus', '私聊') && detail.id != mid"
              @click="chatClick"
              >联系TA</el-button
            >
          </div>
  ...
  methods: {
    ...
    async delClick() {
      await this.$confirm("是否删除此关于我们？")
        .then((_) => {
          this.$http
            .post("aboutus/delete", [this.detail.id])
            .then(async (res) => {
              if (res.data.code == 0) {
                this.$message({
                  type: "success",
