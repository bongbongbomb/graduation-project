  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
        <el-button
          v-if="btnAuth('shixiqingkuang', '新增')"
          :style="{
            cursor: 'pointer',
            border: '0',
            padding: '0px 15px',
          ...
          type="primary"
          @click="add('/index/shixiqingkuangAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      this.$http
        .get(`shixiqingkuang/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/shixiqingkuangDetail", query: params });
    },
