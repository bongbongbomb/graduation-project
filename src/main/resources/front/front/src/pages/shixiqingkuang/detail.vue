  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-breadcrumb-item
          ...
          :key="index"
          :to="'/index/shixiqingkuang?centerType=' + (centerType ? '1' : '0')"
    ...
    >
        ...
        >
          ...
          >
            ...
            <el-button
              ...
              @click="download(detail.shixibaogao)"
              >点击下载</el-button
            >
          </div>
          <div
          ...
          >
            <el-button
              ...
              v-if="btnAuth('shixiqingkuang', '修改')"
              @click="editClick"
              >修改</el-button
            >
            <el-button
              ...
              v-if="btnAuth('shixiqingkuang', '删除')"
              @click="delClick"
              >删除</el-button
            >
            <el-button
              ...
              v-if="btnAuth('shixiqingkuang', '私聊') && detail.id != mid"
              @click="chatClick"
              >联系TA</el-button
            >
            <el-button
              ...
              v-if="btnAuth('shixiqingkuang', '实习报告')"
              @click="onAcross('shixipingjia', '', '', '', '')"
              type="warning"
              >实习报告</el-button
            >
          </div>
      ...
      <el-tabs
        ...
        type="border-card"
      >
        <el-tab-pane label="实习评价" name="first">
          <div v-html="detail.shixineirong"></div>
        </el-tab-pane>
      </el-tabs>
    </div>
    <div
...
export default {
  ...
  methods: {
    ...
    async onAcross(
      ...
      localStorage.setItem("crossTable", `shixiqingkuang`);
    ...
    backClick() {
      ...
      this.$router.push({ path: "/index/shixiqingkuang", query: params });
    },
    // 下载
    download(file) {
      if (!file) {
    ...
    editClick() {
      this.$router.push(
        `/index/shixiqingkuangAdd?type=edit&&id=${this.detail.id}`,
      );
    },
    // 删除
    async delClick() {
      await this.$confirm("是否删除此实习情况？")
        .then((_) => {
          this.$http
            .post("shixiqingkuang/delete", [this.detail.id])
            .then(async (res) => {
              if (res.data.code == 0) {
                this.$message({
                  type: "success",
