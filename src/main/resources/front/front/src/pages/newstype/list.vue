      ...
      >
        ...
        >
          <span
            ...
            class="icon iconfont icon-liulan13"
          ...
          <span
            ...
            class="icon iconfont icon-jiantou06"
          ...
          <span
            ...
            class="icon iconfont icon-jiantou07"
            v-else-if="sortType == 'clicknum' && sortOrder == 'asc'"
          ></span>
          <span :style="{ color: '#fff', lineHeight: '50px', fontSize: '15px' }"
            >点击量</span
          >
        </el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.typename != "")
        searchWhere.typename = "%" + this.formSearch.typename + "%";
      let user = JSON.parse(localStorage.getItem("sessionForm"));
      if (this.sortType) searchWhere.sort = this.sortType;
      if (this.sortOrder) searchWhere.order = this.sortOrder;
      this.$http
        .get(`newstype/${this.centerType ? "page" : "list"}`, {
