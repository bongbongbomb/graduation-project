    ...
    >
      ...
      >
        ...
        >
          ...
          <el-input
            v-model="formSearch.shiximingcheng"
            placeholder="实习名称"
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/shixigangweiAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
      ...
      <div
        ...
        :style="{
          width: '100%',
          padding: '30px 10% 230px',
          margin: '0px 0 10px',
          background:
            'url(http://codegen.caihongy.cn/20240219/48efb4be31ee443597196e704f0766c2.png) center bottom / 100% auto no-repeat,url(http://codegen.caihongy.cn/20240219/e541597a8bf34224a765175ed4cb8569.png) repeat-y center top / 100% auto',
        }"
      >
        <!-- 样式二 -->
        <div
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.fengmian.split(',')[0])"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
              ...
              <img
                ...
                v-else
                :src="
                  baseUrl + (item.fengmian ? item.fengmian.split(',')[0] : '')
                "
                class="image"
              />
            </div>
...
export default {
  ...
  async created() {
    ...
    await this.$http.get("option/gangweileixing/gangweileixing").then((res) => {
      if (res.data.code == 0) {
        this.gangweileixingOptions = res.data.data;
        this.selectOptionsList.push({
          name: "岗位类型",
          list: this.gangweileixingOptions,
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.shiximingcheng != "")
        searchWhere.shiximingcheng = "%" + this.formSearch.shiximingcheng + "%";
      if (this.formSearch.gangweileixing != "")
        searchWhere.gangweileixing = this.formSearch.gangweileixing;
      if (!this.centerType) {
        params["sfsh"] = "是";
      }
      ...
      this.$http
        .get(`shixigangwei/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/shixigangweiDetail", query: params });
    },
...
.list .index-pv1 .animation-box:hover {
  ...
  transform: rotate(0deg) scale(1.02) skew(0deg, 0deg)
