...
export default {
  ...
  methods: {
    ...
    info() {
      this.$http
        .get(`syslog/detail/${this.$route.query.id}`, { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
