    ...
    >
      ...
      >
        ...
        <el-breadcrumb-item
          ...
          :key="index"
          :to="'/index/xuesheng?centerType=' + (centerType ? '1' : '0')"
        ...
        >
          ...
          >
            ...
            <el-button
              ...
              v-if="btnAuth('xuesheng', '私聊') && detail.id != mid"
              @click="chatClick"
              >私聊</el-button
            >
          </div>
  ...
  methods: {
    ...
    async delClick() {
      await this.$confirm("是否删除此学生？")
        .then((_) => {
          this.$http
            .post("xuesheng/delete", [this.detail.id])
            .then(async (res) => {
              if (res.data.code == 0) {
                this.$message({
                  type: "success",
