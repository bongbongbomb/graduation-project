    ...
    >
      ...
      >
        ...
        >
          ...
          <el-input
            v-model="formSearch.xueshengzhanghao"
            placeholder="学生账号"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.touxiang.split(',')[0])"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.xueshengzhanghao != "")
        searchWhere.xueshengzhanghao =
          "%" + this.formSearch.xueshengzhanghao + "%";
      let user = JSON.parse(localStorage.getItem("sessionForm"));
      if (this.sortType) searchWhere.sort = this.sortType;
      if (this.sortOrder) searchWhere.order = this.sortOrder;
      this.$http
        .get(`xuesheng/${this.centerType ? "page" : "list"}`, {
