    ...
    >
      ...
      >
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/luyongtongzhiAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      this.$http
        .get(`luyongtongzhi/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/luyongtongzhiDetail", query: params });
    },
